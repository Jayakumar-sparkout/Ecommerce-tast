...
import { setPayment } from "@/slice/loginslice"
export  function PaymentSuccess() {
    const selector = useSelector((state:RootState)=> state.finalPayment.paymentAmount)
  ...
  const monthName = currentTime.toLocaleString('default', { month: 'long' });
   ...
   const finalTime = `${monthName} ${date}, ${year}at ${hours}:${min}`
      ...
      <Card className="max-w-md w-full space-y-6 p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 pt-6 space-y-4">
          <div className="flex justify-between">
            ...
            <span className="font-medium text-gray-900 dark:text-gray-50">${selector}</span>
          </div>
          <div className="flex justify-between">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-medium text-gray-900 dark:text-gray-50">{finalTime}</span>
          </div>
        </div>
